...
import {BookedServicesCard} from "@/components/booked-services-card.tsx";
...
//
//         // Define month names in Azerbaijani
//         const months = [
...
//
//         // Return the formatted string like '13 Oktyabr - 16:00'
//         return `${day} ${month} - ${hours}:${minutes}`;
//     };
//
//     return (
//         <BackgroundLines className="flex items-center justify-center w-full flex-col px-4">
//             <h2 className="bg-clip-text underline text-transparent text-center bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight">
//                 Bron edildi!
//             </h2>
//             <div
//                 className="max-w-xl mx-auto text-sm space-y-5 md:text-lg text-neutral-700 dark:text-neutral-400 flex flex-col border border-dashed border-primary w-96 p-4 rounded-3xl">
//                 <span className={"text-xl font-bold"}>Rezervasiya nömrən: {bookingId}</span>
//                 <div className={"flex flex-col font-medium"}>
//                     <span>Xidmət: {bookingData.data.map(d=>d.name).join(",")}</span>
//                     <span>Nə zaman: {formatReservationDate(bookingData.reservationDate)}</span>
//                     <span>Qiymət: {bookingData.data.price} AZN</span>
//                 </div>
...
const ReservationSuccessCard = () => {
    ...
    useEffect(() => {
        if (!bookingData) {
            navigate('/login', { replace: true }); // Redirect to login or any other page
        }
    }, [bookingData, navigate]);

    // If bookingData is undefined, return null or a loader to prevent further rendering issues
    if (!bookingData) {
            ...
            <div className="-mb-4 ml-4 mt-2">
                ...
                >
                    <svg
                        height={16}
                        width={16}
                        className="fill-transparent h-5 w-5 rtl:rotate-180"
                        aria-hidden="true"
                    >
            ...
            <main className="mx-auto max-w-3xl">
                <div className="overflow-y-auto z-50 ">
                    <div className="text-center flex items-end justify-center px-4 pb-20 pt-4 sm:flex sm:p-0">
                        <div
                            className="main my-4 flex flex-col transition-opacity sm:my-0   inset-0"
                            aria-hidden="true"
                        >
                            <div
                                className="inline-block transform overflow-hidden rounded-lg border sm:my-8 sm:max-w-xl  bg-default dark:bg-muted border-booker border-booker-width px-8 pb-4 pt-5 text-left align-bottom transition-all sm:w-full sm:py-8 sm:align-middle"
                                role="dialog"
                                aria-modal="true"
                            ...
                            >
                                <div className="">
                                    <div
                                        ...
                                        <MdCheck className={"h-7 w-7 text-green-500"}/>
                                    </div>
                                </div>
                                <div className="mb-8 mt-6 text-center last:mb-0">
                                    ...
                                    <div className="mt-3">
                                        <p className="text-default">
                                            Biz hər iki tərəfə bildiriş göndərəcəyik
                                        </p>
                                    </div>
                                    <div
                                        className="border-subtle text-default mt-8 border-t pt-8 text-left rtl:text-right space-y-5">
                                        <div className={"flex space-x-5 w-full"}>
                                            <BookedServicesCard bookedServices={bookingData.data} selectedIds={bookingData.bookedServicesId}/>

                                            {/*<div className="font-medium w-20">Nə</div>*/}
                                            {/*<div*/}
                                            {/*    className="col-span-2 mb-6 last:mb-0"*/}
                                            {/*    data-testid="booking-title"*/}
                                            {/*>*/}
                                            {/*    {bookingData.data.map((d) => d.name).join(",")}*/}
                                            {/*</div>*/}
                                        ...
                                        <div className={"flex space-x-5 w-full"}>
                                        <div className="font-medium w-20">Nə zaman</div>
                                            <div >
                                                <div className="">
                                                    {formatReservationDate(bookingData.reservationDate)}
                                                </div>
                                            </div>
                                        </div>
                                        {/*<div className="mt-3 font-medium">Harada</div>*/}
                                        {/*<div className="col-span-2 mt-3" data-testid="where">*/}
                                        {/*    <a*/}
                                        {/*        href="https://app.cal.com/video/2Rpp7R4dFhwSZ725DfhaGP"*/}
                                        {/*        target="_blank"*/}
                                        {/*        title="https://app.cal.com/video/2Rpp7R4dFhwSZ725DfhaGP"*/}
                                        ...
                                        {/*            height={16}*/}
                                        {/*            width={16}*/}
                                        {/*            className="fill-transparent text-default inline h-4 w-4"*/}
                                        {/*            aria-hidden="true"*/}
                                        {/*        >*/}
                                    ...
                                    <div
                                        className="text-bookingdark dark:border-darkgray-200 mt-8 text-left dark:text-gray-300"/>
                                </div>
                                <hr className="border-subtle mb-8"/>
                                <div className="text-center last:pb-0">
              <span className="text-emphasis mr-2 rtl:ml-2">
                Dəyişmək lazımdır?
              </span>
                                    <span className="text-default inline">
                <span className="underline" data-testid="reschedule-link">
                  <a href="/reschedule/2Rpp7R4dFhwSZ725DfhaGP?rescheduledBy=maqsudsafin.dev%40gmail.com">
                    Yenidən bron et
                  </a>
                </span>
                <span className="mx-1">və ya</span>
              </span>
                                    <button data-testid="cancel" className="text-default underline">
                                        Ləğv et
                                    </button>
                                </div>
                            </div>
