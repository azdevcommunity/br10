        ...
        <>
            ...
            <div className="h-screen flex lg:flex-row flex-col justify-center items-center bg-on-light-primary text-md">
                ...
                <div className="lg:flex flex-1 h-full w-full">
                    <img src="/assets/abs_bg.png" alt="login-image" className={`object-cover object-center h-[16rem] 
                    max-[320px]:h-[12rem] lg:h-auto`}/>
                </div>
                <Form {...form}>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)}
                        ...
                        <FormField
                            ...
                            render={({field}) => (
                                <FormItem>
                                    <FormMessage/>
                                    <FormControl>
                                        <Input placeholder="Email və ya telefon nömrəsi"
                                               className={"text-md h-12"} {...field} />
                                    </FormControl>
                                </FormItem>
                            )}
                        />
                            ...
                            render={({field}) => (
                                <FormItem>
                                    <FormControl>
                                        ...
                                        <PasswordField
                                            description={<Link href="reset" className={"font-medium mt-4 mb-2"}>Şifrəni
                                                unutmusan?</Link>} className={"text-md h-12"} {...field}/>
                                    </FormControl>
                                </FormItem>
                            )}
                        />
                        ...
                        <div className="text-gray-400 max-[320px]:pb-3">Hesabın yoxdur? <Link href="/register" onClick={() =>navigate("/register") }>Qeydiyyatdan
                            keç!</Link>
                        </div>
                    </form>
